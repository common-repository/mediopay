...
- introduce a tipping button which hides content behind
- introduce "pay what you want" mode
- introduce thresholds, to shut down paywall for all if a certain amount is reached
- adjust size of text in paywall field to length
